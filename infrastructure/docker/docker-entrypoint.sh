...
if [ ! -L /usr/local/share/ca-certificates/cacert.pem ] && [ ! -f /usr/local/share/ca-certificates/cacert.pem ]; then
    ln -s /etc/ssl/certs/cacert.pem /usr/local/share/ca-certificates/cacert.pem
fi
