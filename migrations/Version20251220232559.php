 ...
 */
final class Version20251220232559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE identity (id INT AUTO_INCREMENT NOT NULL, business_service_id INT DEFAULT NULL, public_id VARCHAR(800) NOT NULL, iv VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, secret VARCHAR(800) NOT NULL, credential_secret VARCHAR(800) NOT NULL, private_id VARCHAR(800) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, privacy_policy TINYINT(1) DEFAULT NULL, fcm_token JSON DEFAULT NULL, UNIQUE INDEX UNIQ_6A95E9C42DFFA14D (business_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
