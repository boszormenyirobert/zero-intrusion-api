...
final class DomainDeleteControllerIntegrationTest extends WebTestCase
{
    ...
    public function testDomainDeleteStateReturnsSuccessPayload(): void
    {
        ...
        static::getContainer()->set(DomainDeleteStateService::class, $stateService);
